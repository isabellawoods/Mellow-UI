...
## Updated Screens
As of version **4.5.0**, most screens accessed from the title screen have been updated, except for a few (like the resource packs screen).
...
| <img src="assets/options.png" width=1170/> | *The options screen, with the reintroduction of super secret settings, and some new buttons as well.* |
| <img src="assets/create_new_world.png" width=1170/> | *The create new world screen, backported from [**Java Edition 1.19.4**](https://minecraft.wiki/w/Java_Edition_1.19.4). Still a work in progress though!* |
