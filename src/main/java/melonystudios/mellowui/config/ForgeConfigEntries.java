...
public class ForgeConfigEntries {
    ...
    public static final BooleanOption ZOOM_MISSING_MODEL_TEXT_IN_GUIS = new BooleanOption("config.forge.zoom_missing_text_in_guis", new TranslationTextComponent("config.forge.zoom_missing_text_in_guis.tooltip"),
            options -> CLIENT.zoomInMissingModelTextInGui.get(), (options, newValue) -> CLIENT.zoomInMissingModelTextInGui.set(newValue));
    public static final BooleanOption THREADED_CHUNK_RENDERING = new BooleanOption("config.forge.threaded_chunk_rendering", new TranslationTextComponent("config.forge.threaded_chunk_rendering.tooltip"),
            options -> CLIENT.alwaysSetupTerrainOffThread.get(), (options, newValue) -> CLIENT.alwaysSetupTerrainOffThread.set(newValue));
    public static final BooleanOption EXPERIMENTAL_LIGHT_PIPELINE = new BooleanOption("config.forge.experimental_light_pipeline", new TranslationTextComponent("config.forge.experimental_light_pipeline.tooltip"),
    ...
    public static final BooleanOption FORGE_LIGHT_PIPELINE = new BooleanOption("config.forge.forge_light_pipeline", new TranslationTextComponent("config.forge.forge_light_pipeline.tooltip"),
            options -> CLIENT.forgeLightPipelineEnabled.get(), (options, newValue) -> CLIENT.forgeLightPipelineEnabled.set(newValue));
    public static final BooleanOption SHOW_LOAD_WARNINGS = new BooleanOption("config.forge.show_load_warnings", new TranslationTextComponent("config.forge.show_load_warnings.tooltip"),
            options -> CLIENT.showLoadWarnings.get(), (options, newValue) -> CLIENT.showLoadWarnings.set(newValue));
    public static final BooleanOption FORGE_CLOUDS = new BooleanOption("config.forge.gpu_cloud_rendering", new TranslationTextComponent("config.forge.gpu_cloud_rendering.tooltip"),
            options -> CLIENT.forgeCloudsEnabled.get(), (options, newValue) -> CLIENT.forgeCloudsEnabled.set(newValue));
    public static final BooleanOption SELECTIVE_RESOURCE_LOADING = new BooleanOption("config.forge.selective_resource_loading", new TranslationTextComponent("config.forge.selective_resource_loading.tooltip"),
            options -> CLIENT.selectiveResourceReloadEnabled.get(), (options, newValue) -> CLIENT.selectiveResourceReloadEnabled.set(newValue));
    public static final BooleanOption USE_COMBINED_DEPTH_STENCIL_ATTACHMENT = new BooleanOption("config.forge.use_combined_depth_stencil_attachment", new TranslationTextComponent("config.forge.use_combined_depth_stencil_attachment.tooltip"),
    ...
    // Server config
    public static final BooleanOption REMOVE_ERRORING_ENTITIES = new BooleanOption("config.forge.remove_erroring_entities", new TranslationTextComponent("config.forge.remove_erroring_entities.tooltip"),
            options -> SERVER.removeErroringEntities.get(), (options, newValue) -> SERVER.removeErroringEntities.set(newValue));
    public static final BooleanOption REMOVE_ERRORING_BLOCK_ENTITIES = new BooleanOption("config.forge.remove_erroring_block_entities", new TranslationTextComponent("config.forge.remove_erroring_block_entities.tooltip"),
            options -> SERVER.removeErroringTileEntities.get(), (options, newValue) -> SERVER.removeErroringTileEntities.set(newValue));
    public static final BooleanOption FIX_VANILLA_CASCADING = new BooleanOption("config.forge.fix_vanilla_cascading", new TranslationTextComponent("config.forge.fix_vanilla_cascading.tooltip"),
            options -> SERVER.fixVanillaCascading.get(), (options, newValue) -> SERVER.fixVanillaCascading.set(newValue));
    public static final BooleanOption LOG_CASCADING_WORLD_GENERATION = new BooleanOption("config.forge.log_cascading_world_generation", new TranslationTextComponent("config.forge.log_cascading_world_generation.tooltip"),
            options -> SERVER.logCascadingWorldGeneration.get(), (options, newValue) -> SERVER.logCascadingWorldGeneration.set(newValue));
    public static final BooleanOption FULL_BOUNDING_BOX_LADDERS = new BooleanOption("config.forge.full_bounding_box_ladders", new TranslationTextComponent("config.forge.full_bounding_box_ladders.tooltip"),
            options -> SERVER.fullBoundingBoxLadders.get(), (options, newValue) -> SERVER.fullBoundingBoxLadders.set(newValue));
    public static final BooleanOption FIX_ADVANCEMENT_LOADING = new BooleanOption("config.forge.fix_advancement_loading", new TranslationTextComponent("config.forge.fix_advancement_loading.tooltip"),
            options -> SERVER.fixAdvancementLoading.get(), (options, newValue) -> SERVER.fixAdvancementLoading.set(newValue));
    public static final BooleanOption TREAT_EMPTY_TAGS_AS_AIR = new BooleanOption("config.forge.treat_empty_tags_as_air", new TranslationTextComponent("config.forge.treat_empty_tags_as_air.tooltip"),
    ...
    public static final SliderPercentageOption BABY_ZOMBIE_CHANCE = new SliderPercentageOption("config.forge.baby_zombie_chance", 0, 1, 0,
            ...
            (options, slider) -> {
                slider.setTooltip(Minecraft.getInstance().font.split(new TranslationTextComponent("config.forge.baby_zombie_chance.tooltip"), TOOLTIP_MAX_WIDTH));
    ...
    public static final SliderPercentageOption BASE_ZOMBIE_SUMMON_CHANCE = new SliderPercentageOption("config.forge.base_zombie_summon_chance", 0, 1, 0,
            ...
            (options, slider) -> {
                slider.setTooltip(Minecraft.getInstance().font.split(new TranslationTextComponent("config.forge.base_zombie_summon_chance.tooltip"), TOOLTIP_MAX_WIDTH));
    ...
    public static final SliderPercentageOption DIMENSION_UNLOAD_QUEUE_DELAY = new SliderPercentageOption("config.forge.dimension_unload_queue_delay", 0, 100, 1,
            ...
            (options, slider) -> {
                slider.setTooltip(Minecraft.getInstance().font.split(new TranslationTextComponent("config.forge.dimension_unload_queue_delay.tooltip"), TOOLTIP_MAX_WIDTH));
