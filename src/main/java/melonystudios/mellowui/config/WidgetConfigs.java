...
public class WidgetConfigs {
    ...
    public WidgetConfigs(ForgeConfigSpec.Builder builder) {
        ...
        this.modEntryTextPadding = builder.comment("Border padding for a mod list entry's text. Defaults to 2mpx.", "Effectively capped at 'entryWidth / 2 - 1'.").translation("config.mellowui.mod_entry_text_padding").defineInRange("modEntryTextPadding", 2, 0, Integer.MAX_VALUE);
