...
public class WidgetConfigs {
    ...
    public final ForgeConfigSpec.IntValue highContrastFlairAccentColor; // temporary configs until I actually add mod list flairs ~isa 14-9-25
    ...
    public WidgetConfigs(ForgeConfigSpec.Builder builder) {
        ...
        this.highlightedIconButtonColor = builder.comment("Text color for a highlighted icon button on the title screen.").defineInRange("widget.highlightedIconButtonColor", 0xFFFFA0, 0, 0xFFFFFF);
        ...
        this.highContrastSplashTextColor = builder.comment("The color to use for the splash text while the high contrast resource pack is enabled.").translation("config.mellomedley.splash_text_color").defineInRange("splash.highContrastTextColor", 0x57FFE1, 0, 0xFFFFFF);
