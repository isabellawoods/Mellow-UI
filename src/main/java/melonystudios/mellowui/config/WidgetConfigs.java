...
public class WidgetConfigs {
    ...
    public WidgetConfigs(ForgeConfigSpec.Builder builder) {
        builder.push("widget");
        this.buttonTextPadding = builder.comment("Border padding for a button with scrolling text. Defaults to 2px.", "Effectively capped at the 'buttonWidth / 2 - 1'.").translation("config.mellowui.button_text_padding").defineInRange("buttonTextPadding", 2, 0, Integer.MAX_VALUE);
        ...
        this.descriptionTextColor = builder.comment("The color used for descriptions in Mellow UI.").translation("config.mellowui.description_text_color").defineInRange("miscellaneous.descriptionTextColor", 0xAAAAAA, 0, 0xFFFFFF);
        builder.pop();
    }
}
