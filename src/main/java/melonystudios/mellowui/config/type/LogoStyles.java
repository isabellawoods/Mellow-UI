...
@OnlyIn(Dist.CLIENT)
public enum LogoStyles implements StringRepresentable {
    ...
    /// Renders a **logo**.
    /// @param stack The {@link PoseStack} instance used for rendering.
    ...
    public void renderLogo(PoseStack stack, Screen screen, boolean useDefaultValues, int x, int y, int width, int height, float transparency, boolean keepLogoThroughFade) {
    ...
    public interface StyleRenderer {
        ...
        /// @param transparency The transparency of the logo, usually ranging from `0` to `1`.
        /// @param keepLogoThroughFade Whether to keep the logo visible during the fading animation.
        void renderLogo(PoseStack stack, Screen screen, boolean useDefaultValues, int x, int y, int width, int height, float transparency, boolean keepLogoThroughFade);
    }
}
