...
public class MellowModListScreen extends Screen {
    ...
    public MellowModListScreen(Screen lastScreen) {
        super(new TranslationTextComponent("menu.mellowui.mods.title", ModList.get().size()));
    ...
    protected void init() {
        ...
        this.panel = new Panel(this.modList.getRight() + 2, 34, (this.modList.getRight() / 2) + (this.width / 4) * 3, this.height - 66, this, new TranslationTextComponent("panel.mellowui.mod_information"));
    ...
    public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(stack, this.font, new TranslationTextComponent("menu.mellowui.mods.links"), (this.modList.getRight() / 2) + rightSeparatorX, MellowUtils.DEFAULT_TITLE_HEIGHT, 0xFFFFFF);
        if (this.selectedMod == null) {
            drawCenteredString(stack, this.font, new TranslationTextComponent("menu.mellowui.mods.no_mod_selected").withStyle(TextFormatting.GRAY), this.width / 2, this.height / 2 - 5, 0xFFFFFF);
        }
    ...
    private void updateCache() {
        ...
        this.updateAvailableButton.active = this.updateAvailableButton.visible = VersionChecker.getResult(info).url != null;
    }
