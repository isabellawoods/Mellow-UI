...
public class MellomedleyTitleScreen extends Screen implements InterfaceMethods.TitleScreenMethods {
    ...
    public MellomedleyTitleScreen(boolean fading, boolean keepLogoThroughFade) {
        super(new TranslatableComponent("menu.mellomedley.title").withStyle(TextComponents.titleStyle()));
        this.fading = fading;
    ...
    public void render(PoseStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        RenderSystem.setShaderTexture(0, GUITextures.TITLE_SCREEN_GRADIENT_LIGHT);
