...
public class FontSettingsScreen extends SettingsScreen {
    private static final List<AbstractOption> SETTINGS = Lists.newArrayList(VanillaConfigEntries.FORCE_UNICODE_FONT);
    private final RenderComponents components = RenderComponents.INSTANCE;
    private OptionsRowList list;

    public FontSettingsScreen(Screen lastScreen, GameSettings options) {
        super(lastScreen, options, new TranslationTextComponent("menu.mellowui.font_settings.title").withStyle(TextComponents.titleStyle()));
    }
