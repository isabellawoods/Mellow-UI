...
public class LoadingErrorsScreen extends Screen {
    ...
    public LoadingErrorsScreen(List<ModLoadingException> errors, List<ModLoadingWarning> warnings, @Nullable Path dumpedLocation) {
        super(new TranslationTextComponent("menu.mellowui.loading_errors.title").withStyle(TextComponents.titleStyle()));
    ...
    protected void init() {
        ...
        this.errorHeader = new TranslationTextComponent("menu.mellowui.loading_errors.error_header").withStyle(TextFormatting.RED, TextFormatting.BOLD);
        this.warningHeader = new TranslationTextComponent("menu.mellowui.loading_errors.warning_header").withStyle(TextFormatting.YELLOW, TextFormatting.BOLD);
