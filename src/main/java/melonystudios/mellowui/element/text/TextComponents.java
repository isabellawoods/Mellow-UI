...
/// Utility methods for creating {@linkplain ITextComponent text components}, {@linkplain Style styles} and colors in *Mellow UI*.
public class TextComponents {
    public static final String PROGRAMMER_ART_ID = "programer_art";
    public static final ITextComponent ELLIPSIS = new TranslationTextComponent("menu.mellowui.ellipsis");
