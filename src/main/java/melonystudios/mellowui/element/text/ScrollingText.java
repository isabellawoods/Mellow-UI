...
public interface ScrollingText {
    ...
    default void renderAlignedScrollingText(FontRenderer font, ITextComponent text, Alignment alignment, int minX, int minY, int maxX, int maxY, int color) {
        this.renderAlignedScrollingText(font, text, alignment, (minX + maxX) / 2, minX, minY, maxX, maxY, color);
    }

    default void renderAlignedScrollingText(FontRenderer font, ITextComponent text, Alignment alignment, int centerX, int minX, int minY, int maxX, int maxY, int color) {
    ...
    default void renderScrollingText(ITextComponent text, int minX, int minY, int maxX, int maxY, int color, int textWidth, int buttonWidth, int textY) {
        ...
        double xOffset = MathHelper.lerp(i4, 0, widthDiff);
