package melonystudios.mellowui.util.pack;
...
public class HighContrastPack extends ResourcePack {
    public static final String PACK_LOCATION = "assets/mellowui/resourcepacks/high_contrast/";
    ...
    public String getName() {
        return new TranslationTextComponent("resource_pack.mellowui.high_contrast").getString();
    }
