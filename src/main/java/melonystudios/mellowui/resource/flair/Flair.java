...
/// **Flairs** are customization options applied to a mod's entry on {@linkplain melonystudios.mellowui.screen.update.MellowModListScreen *Mellow UI*'s mod list screen}.
public class Flair {
